...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(400)
      .json({ message: 'Error creating product', error: error?.message || 'Unknown error' });
  }
});
...
router.put('/:id', async (req: Request<{ id: string }>, res: Response) => {
  try {
    ...
    res
      .status(400)
      .json({ message: 'Error updating product', error: error?.message || 'Unknown error' });
  }
});
...
router.delete('/:id', async (req: Request<{ id: string }>, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Error deleting product', error: error?.message || 'Unknown error' });
  }
});
