...
export const checkPermissions = (requiredPermissions: Permission[]) => {
  return (req: Request, res: Response, next: NextFunction): void => {
    try {
      ...
      const hasAllPermissions = requiredPermissions.every((permission) => hasPermission(userRole, permission))
...
export const checkAnyPermission = (requiredPermissions: Permission[]) => {
  return (req: Request, res: Response, next: NextFunction): void => {
    try {
      ...
      const hasAnyPermission = requiredPermissions.some((permission) => hasPermission(userRole, permission))
