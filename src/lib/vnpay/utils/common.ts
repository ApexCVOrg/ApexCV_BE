 ...
 * @returns Date
 */
export function parseDate(dateNumber: number | string, tz: 'utc' | 'local' | 'gmt7' = 'local'): Date {
...
export function hash(secret: string, data: BinaryLike | string | Buffer, algorithm: HashAlgorithm): string {
