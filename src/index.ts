...
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://nidas-payment.vercel.app'
const EXTRA_ORIGINS = process.env.EXTRA_ORIGINS?.split(',') || []

// Danh sách origin được phép
const allowedOrigins = [
  FRONTEND_URL,
  'https://nidas-payment.vercel.app',
  'https://nidas-payment.vercel.app/en',
  'https://nidas-payment.vercel.app/vi',
  'http://localhost:3000',
  ...EXTRA_ORIGINS
]
